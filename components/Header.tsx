...
const Header: React.FC<HeaderProps> = ({ onOpenManual, onOpenPassengerList }) => {
  ...
  const buttonBaseClass = "flex items-center justify-center gap-2 px-4 py-2 rounded-lg font-black text-[10px] uppercase transition-all shadow-md transform hover:-translate-y-0.5 active:translate-y-0 min-w-fit h-10 text-center whitespace-nowrap border border-transparent";
    ...
    <header className="bg-[#001f54] text-white shadow-xl">
      <div className="container mx-auto px-4 py-4 md:py-6">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-row flex-wrap justify-center lg:justify-end gap-2 w-full lg:w-auto">
            <button 
