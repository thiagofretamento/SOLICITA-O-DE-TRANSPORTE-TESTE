...
export const SETOR_OPTIONS = [
  "OUTROS", "AAFG", "AJGGPE", "AJUG", "ASTEC", "CAC", "CAGP", "CALF", "CBR", "CCEFP", "CEAI", 
  "CECEB", "CECF", "CEEI", "CGPP", "CNP", "COEFP", "CORREGED", "CPL I", "CPL III", "CPL IV", 
  "CPM", "CPPU", "CTG", "CTNE", "CTPETE", "FUNDEF", "GABSEDE", "GABSEE", "GACE", "GAM", 
  "GAPE", "GAPRO", "GATG", "GCES", "GCINC", "GCODA", "GCOMP", "GCRE", "GDEP", "GEAME", 
  "GEARE", "GECAP", "GECON", "GEDES", "GEDH", "GEFP", "GEINT", "GEJAI", "GELIC", "GELOG", 
  "GEMAP", "GEMR", "GENSE", "GEOE", "GEPAF", "GEPCC", "GEPEC", "GEPEM", "GEPFI", 
  "GEPLA / APLAN", "GEPLO", "GEPPE", "GERED", "GERET", "GERJI", "GERJS", "GERPE", "GESAD", 
  "GETAF", "GETAN", "GETRA", "GGADM", "GGAE", "GGAJ", "GGCP", "GGEAF", "GGEI", "GGEP", 
